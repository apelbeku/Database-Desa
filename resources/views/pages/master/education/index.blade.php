                  ...
                  <div class="col-12">
                      <div class="card">
                          <div class="card-header d-flex justify-content-between">
                              ...
                              <div class="w-25 pl-5">
                                  <a href="{{ route('pendidikan.trashed') }}" class="btn btn-teal btn-sm">Trashed</a>
                                  <a href="{{ route('pendidikan.create') }}" class="btn btn-primary btn-sm float-right">Tambah</a>
                              </div>
                          </div>
                          <div class="card-content collapse show">
                              <div class="card-body">
                                          ...
                                          <tbody>
                                            ...
                                            @foreach ($educations as $education)
                                              <tr>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-warning btn-sm" href="{{ route('pendidikan.edit', $education->id) }}">Edit</a>
                                                        <form class="d-inline" action="{{ route('pendidikan.destroy', $education->id) }}" method="POST">
                                                            @csrf @method('DELETE')

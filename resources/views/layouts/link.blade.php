    ...
    <link rel="apple-touch-icon" href="/template/theme-assets/images/ico/apple-icon-120.png">
    <link rel="shortcut icon" type="image/x-icon" href="/template/theme-assets/images/ico/favicon.ico">
